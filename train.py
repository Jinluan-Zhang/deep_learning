    ...
    if args.weights != "":
        ...
        for k in del_keys:
            if k in weights_dict:
                ...
                print(f"Warning: {k} not found in weights_dict, skipping...")

        # 加载权重，strict=False 允许缺失部分键
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="./data/flower_photos", help='data path')
